...
<head>
    ...
    <title>แบบทดสอบบทเรียนที่ 3</title>
...
<body>
    ...
    <?php
        ...
        ///เปลี่ยน
        $sql = "SELECT * FROM tbl_rptsubject WHERE tbl_rptsubject.userId ='$UserID' AND tbl_rptsubject.subjectId = 5";
    ...
    <div class="card-body">
        <div style="text-align: left;">
            ...
            <br>
            <i class="bi bi-card-checklist"></i> เนื้อหา : อุปกรณ์ไร้สาย (Wireless device) <!--เปลี่ยน-->
        </div>
        <div class="row g-0">
            <div class="col-md-4">
                <br>
                <img src="images/cover_page6.gif" class="card-img-top" alt="..." style="width: 100%;">
                <br>
                <!--เปลี่ยน-->
            </div>
            <div class="col-md-8">
                <div class="card-body" style="text-align: left;">
                    <ul class="list-group list-group-flush">
                        ...
                        <center>
                            <?php
                            if($score_subject5 >= 1){ ///เปลี่ยน ?>
                            <div class="alert alert-success" role="alert" style="width: 100%;">
                                <div>
                                    <h1><i class="bi bi-check-circle-fill"></i></h1>
                                    <h3>Well Done, You <b> Pass </b> Wireless device.</h3>
                                </div>
                                <div class="alert alert-light" role="alert" style="width: 100%;">
                                    <table style="width: 100%;">
                                        <tr>
                                            ...
                                            <td style="text-align: right;">
                                                <a href="action_quizedit.php?editquiz=3" class="btn btn-dark"
                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tr>
                                        <?php
                                            $sql_percent="SELECT * FROM tbl_rptpercent WHERE tbl_rptpercent.userId = $UserID AND tbl_rptpercent.subjectId = 5";
                                    ...
                                    <a href="answer_exam1.php" class="btn btn-dark" role="button">เฉลยข้อสอบ</a>
                                </div>
                                <?php                       
                                    }
                                ?>
                            ...
                            <div class="alert alert-danger" role="alert" style="width: 100%;">
                                <div>
                                    ...
                                    <h3>I'm sorry, You <b> Failed </b> Wireless device.</h3>
                                </div>
                                <div class="alert alert-light" role="alert" style="width: 100%;">
                                    <table style="width: 100%;">
                                        <tr>
                        ...
                        <?php
                                    $sql_quiz1 = "SELECT * FROM tbl_lesson3 WHERE subjectId = 5";   ///เปลี่ยน
                        ...
                        <li class="list-group-item">
                            ...
                            <div style="text-align: right;">
                                <input type="hidden" name="quiz" value="3"> <!-- เปลี่ยน -->
