<?php
    ...
    if(!$q){
        echo"<script>window.alert('UPDATE ไม่ข้อมูลสำเร็จ!'); window.location='index.php'</script>";
    }
        echo"<script>window.alert('UPDATE ข้อมูลสำเร็จ!'); window.location='index.php'</script>";
?>