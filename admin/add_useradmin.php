...
<body>
    ...
    <br>
    <br>
    <h3> &nbsp; &nbsp; &nbsp; <b><i class="bi bi-person-plus-fill"></i> เพิ่มรายชื่อผู้ใช้งาน สำหรับ Admin เท่านั้น </b></h3>
        <center>
            <div class="shadow-lg p-3 mb-5 bg-light rounded" role="alert" style="width: 50%;">
            <br>
                    <B><h1>สมัครสมาชิกเพิ่มเติม </h1></B>
                    <br>
                    <form action="action_adduseradmin.php" method="post" class="row g-3" enctype="multipart/form-data" name="form1" id="form1">
