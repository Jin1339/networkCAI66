<?php
    ...
    include('../connect.php');
    $CId = $_GET['CId'];
    $sql = "SELECT * FROM tbl_comment,tbl_question WHERE tbl_question.question_Id = tbl_comment.question_Id AND tbl_comment.comment_Id = $CId";
...
<head>
    ...
    <title>จัดการแก้ไขตอบกลับกระทู้ความคิดเห็น</title>
    ...
    <center>
        <div class="card" style="width: 60%;">
            <div class="card-header" style="text-align: left;">
                <h4><b>จัดการแก้ไขตอบกลับกระทู้ความคิดเห็น <i class="bi bi-chat-dots"></i></b></h4>
            </div>
                ...
                <blockquote class="blockquote mb-0">
                    <table style="width: 95%; text-align: center;">
                        <tr>
                            ...
                            <td valign="top">
                                <input type="text" class="form-control" name="name" id="" aria-describedby="helpId" placeholder="" value="<?php echo $data['topic_title'] ?>" disabled>    
                                <br>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td valign="top">
                                <textarea class="form-control" name="detail" id="" rows="3"><?php echo $data['detail_comment'] ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: right; width: 20%;" valign="top">
                            ...
                            <td valign="top" >
                                ...
                                <input type="text" class="form-control" name="nameuser" id="" aria-describedby="helpId" placeholder="" value="<?php echo $data['username_comment'] ?>">
