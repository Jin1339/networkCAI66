                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td style="width: 15%; text-align: left;"><font color="#33CC00">
                                    <img src="..\images\<?php echo $data['answer']; ?>" width="150px">
                                </td>
                                <td style="width: 10%; text-align: center;"><a href="edit_exam3.php?subid=<?php echo $data['Id']; ?>" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a></td>
                                <td style="width: 10%; text-align: center;"><a href="action_deletexam3.php?subid=<?php echo $data['Id']; ?>" class="btn btn-danger"><i class="bi bi-dash-lg"></i></a></td>
                            </tr>
                    <?php
                        }
