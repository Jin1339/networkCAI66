...
<body>
    ...
    <?php
        if(mysqli_num_rows($q)==0){
            ...
            <table class="table table-success table-striped-columns" style="width: 80%;">
                <thead>
                    ...
                    ?>
                            <tr>
                                ...
                                <td style="width: 50%; text-align: left;">
                                    ...
                                    <h5>A. &nbsp; &nbsp; <img src="..\images\<?php echo $data['choice_A']; ?>" width="150px"> &nbsp; &nbsp;  &nbsp; &nbsp;  &nbsp; &nbsp; 
                                    B. &nbsp; &nbsp; <img src="..\images\<?php echo $data['choice_B']; ?>" width="150px"></h5>
                                    <h5>C. &nbsp; &nbsp; <img src="..\images\<?php echo $data['choice_C']; ?>" width="150px"> &nbsp; &nbsp;  &nbsp; &nbsp;  &nbsp; &nbsp; 
                                    D. &nbsp; &nbsp; <img src="..\images\<?php echo $data['choice_D']; ?>" width="150px"></h5>
                                </td>
                                <td style="width: 15%; text-align: center;"><font color="#33CC00">
                                    <img src="..\images\<?php echo $data['answer']; ?>" width="200px">
                                </td>
                                <td style="width: 10%; text-align: center;"><a href="edit_exam5.php?subid=<?php echo $data['Id']; ?>" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a></td>
                                <td style="width: 10%; text-align: center;"><a href="action_deletexam5.php?subid=<?php echo $data['Id']; ?>" class="btn btn-danger"><i class="bi bi-dash-lg"></i></a></td>
                            </tr>
                    <?php
                        }
