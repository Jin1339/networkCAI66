<?php
    ...
    $sql = "UPDATE `tbl_prestudytest` SET `question` = '$namelesson', `choice_A` = '$choice1', `choice_B` = '$choice2', `choice_C` = '$choice3', `choice_D` = '$choice4', `answer` = '$answer'  WHERE `tbl_prestudytest` .`Id` = $id;";
