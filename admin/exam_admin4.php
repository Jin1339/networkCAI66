                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td style="width: 10%; text-align: center;"><a href="edit_exam4.php?subid=<?php echo $data['Id']; ?>" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a></td>
                                <td style="width: 10%; text-align: center;"><a href="action_deletexam4.php?subid=<?php echo $data['Id']; ?>" class="btn btn-danger"><i class="bi bi-dash-lg"></i></a></td>
                            </tr>
                    <?php
                        }
