<?php
    ...
    $answer = $_POST['answer'];
    $sql = "INSERT INTO `tbl_afterstudytest`(`question`, `choice_A`, `choice_B`, `choice_C`, `choice_D`, `answer`, `subjectId`) VALUES ('$namelesson','$choice1','$choice2','$choice3','$choice4','$answer','2')";
