...
<center>
    <table style="width: 90%;">
        <tr style="width: 50%;">
            <td>
                ...
                <h4 class="alert-heading">แบบทดสอบหลังเรียน (Final Test)!</h4>
                ...
                <hr>
                <?php
                    $sql_user ="SELECT * FROM `tbl_user`,tbl_answermyuser WHERE tbl_answermyuser.id_user = tbl_user.userId AND tbl_user.userId = $userId AND tbl_answermyuser.subjectId = 2";
                    $q_user = mysqli_query($con, $sql_user);
                    $data_user = mysqli_fetch_array($q_user);
                ?>
                ผู้สอบ : <?php echo $data['name'];?> <?php echo $data_user['lastname'];?>
            ...
            <td style="width: 50%;">
                ...
                <table class="table table-striped table-hover">
                    <?php
                        $sql_percent="SELECT * FROM `tbl_rptpercent` WHERE userId = $userId AND `subjectId` = 2";
    ...
    <tr style="text-align: center;">
        <td colspan="2">
            <a href="finalanswer_exam.php" class="btn btn-dark d-grid gap-2 col-6 mx-auto" role="button">เฉลยข้อสอบหลังเรียน</a>
        </td>
    </tr>
    </table>
</center>
