...
<?php error_reporting(E_ERROR | E_PARSE); ?>
    <?php
            ...
            <br>
            <br>
            <!-- ถ้าไม่มีการ Log in ให้ขึ้นข้อความดังกล่าว -->
            <center>
            ...
            <!-- แสดง ตารางผลการเรียน ของรหัสผู้ใช้งาน ที่ เข้าสู่ระบบ-->
            <?php
            }else{
                $sql = "SELECT * FROM tbl_academicresults WHERE tbl_academicresults.userId = $id_user";
                $q = mysqli_query($con, $sql);
                if(mysqli_num_rows($q)){?>
                
                    <!-- ถ้า ตารางผลการเรียน มีการ รหัสผู้ใช้งาน ที่ เข้าสู่ระบบแล้วให้ไปหน้า academic.php เพื่อโชว์คะแนน -->
                <?php
